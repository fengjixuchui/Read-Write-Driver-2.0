...
{
    if (m_pDrawList->m_DrawCount < MAX_DRAW) {
...
bool CDwmMsg::_InitExeMsg()
{
    ...
    m_hFileMapping = CreateFileMappingA(INVALID_HANDLE_VALUE, &sa, PAGE_READWRITE, 0, MAPINGLEN, MAPNAME);
